...
int main()
{
  ...
  auto window { glfwCreateWindow(
      WINDOW_WIDTH, WINDOW_HEIGHT, "Title", nullptr, nullptr) };
  ...
  glShaderSource(fragment_shader_1, 1, &fragment_shader_1_source, nullptr);
  glShaderSource(fragment_shader_2, 1, &fragment_shader_2_source, nullptr);
  ...
  if (!successful) {
    log_shader_error(vertex_shader_1, "Error::Shader::Vertex::Compilation");
  }
  ...
  if (!successful) {
    log_shader_error(vertex_shader_2, "Error::Shader::Vertex::Compilation");
  }
  ...
  if (!successful) {
    log_shader_error(fragment_shader_1, "Error::Shader::Fragment::Compilation");
  }
  ...
  if (!successful) {
    log_shader_error(fragment_shader_2, "Error::Shader::Fragment::Compilation");
  }
  ...
  if (!successful) {
    log_shader_error(program_shader_1, "Error::Shader::Program::Linking");
  }
  ...
  if (!successful) {
    log_shader_error(program_shader_2, "Error::Shader::Program::Linking");
  }

  glValidateProgram(program_shader_1);
  glValidateProgram(program_shader_2);

  auto uniform_location { glGetUniformLocation(program_shader_2, "offset_x") };
